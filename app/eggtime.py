...
@click.command()
@click.option("-m", "--mass", "m", default=60, help="Egg mass [g]")
@click.option("-s", "--t0", "t0", default=6, help="Starting temperature [°C]")
@click.option("-t", "--t1", "t1", default=72, help="Target temperature [°C]")
@click.option("-e", "--elevation", "e", default=0, help="Elevation above sea level [m]")
def main(m, t0, t1, e):
